...
impl Handles {
    ...
    pub fn new(db: &PgnDatabase) -> Self {
        ...
        Self {
            ...
            wd_wind_speed: f("windData", "Wind Speed"),
            wd_wind_angle: f("windData", "Wind Angle"),
            ...
            sp_speed_water_referenced: f("speed", "Speed Water Referenced"),
            wd_depth: f("waterDepth", "Depth"),
            wd_offset: f("waterDepth", "Offset"),
            dl_log: f("distanceLog", "Log"),
            dl_trip_log: f("distanceLog", "Trip Log"),
            ...
            dops_actual_mode: f("gnssDops", "Actual Mode"),
            dops_hdop: f("gnssDops", "HDOP"),
            dops_vdop: f("gnssDops", "VDOP"),
            env_temp_source: f("environmentalParameters", "Temperature Source"),
