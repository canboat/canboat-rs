...
/// Days-since-1970-01-01 → `(year, month, day)`. Howard Hinnant
/// civil-from-days algorithm (public domain). Duplicated from
/// `ydwg02.rs` to keep the format modules self-contained.
